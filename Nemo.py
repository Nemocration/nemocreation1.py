...
try:
    ...
    os.system('python2 Nemocreation.py')
...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕ NEM0▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕Nemocreation▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94Nemocreation.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93Nemocreation\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............
 
\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
 
\033[1;91m☞ Auther     : NEMO_CREATION_MASTER
\033[1;92m☞ WhatsApp   : 03013415709
\033[1;95m☞ YouTube    : https://youtu.be/YpbYWkp32Ew
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://youtu.be/YpbYWkp32Ew
		    menu()
		else:
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Nemo_cration Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' https://youtu.be/7xKSp2dm9GE WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Nemo_creation')
	    os.system('cd $HOME && git clone https://github.com/Nemocreation/nemo)
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03013415709✓')
	    psb('WellCome To Nemo_creation')
	    psb('Congratulations Nemo_creation Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ nemo✓')
	    psb('🔓Password ☆ creation✓')
	    psb('Subscrib My Youtube Channel https://youtu.be/YpbYWkp32Ew✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Nemo_creation && python2 nemo.py')
	elif bm =='3
	    os.system('xdg-op
	    menu()
	elif bm =='4':
			    ...
			    if 'access_token' in k:
			        ...
			        if 'www.facebook.com' in k['error_msg']:
			            ...
			            if 'access_token' in k:
			                ...
			                ps3=(j['first_name']+'Nemo_creation')
